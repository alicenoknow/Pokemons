...
import { Papaj } from "../utils/requires";
...
export default function GameOverScreen(
  ...
  useEffect(() => {
    Animated.parallel([
      ...
      Animated.timing(xScaleVal, {
        toValue: 1,
        duration: 800,
        useNativeDriver: true,
      }),
      Animated.timing(yScaleVal, {
        toValue: 1,
        duration: 800,
        useNativeDriver: true,
      }),
  ...
  return (
    <View style={styles.containerMain}>
      <Animated.Image
        style={{
          transform: [{ rotate: spin }, { scaleX: xScale }, { scaleY: yScale }],
          ...styles.img,
        }}
        source={Papaj}
      />
